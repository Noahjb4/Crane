...
{
    public Rotation SlewBodyRotation;
    ...
    private void Update()
    {
        if(SlewBodyRotation.isMoving == true)
        {
            m_Rigidbody.constraints = RigidbodyConstraints.FreezeAll;
        }
        else
        {
            m_Rigidbody.constraints = RigidbodyConstraints.FreezePositionZ | RigidbodyConstraints.FreezeRotationZ | RigidbodyConstraints.FreezePositionX | RigidbodyConstraints.FreezeRotationX | RigidbodyConstraints.FreezeRotationY;
        }
    }

    void FixedUpdate()
    {
        if (SlewBodyRotation.isMoving == false)
        {
            Debug.Log("isMoving is false");
            Debug.Log("in the Button Interactable Script");
